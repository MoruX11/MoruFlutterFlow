...
import '/info/delete_product/delete_product_widget.dart';
...
class _ProductosWidgetState extends State<ProductosWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Productos'});
          ...
          child: Stack(
            children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) =>
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProductsRecord>
                                    buscadorProductsRecordList = snapshot.data!;
                                    ...
                                    child: Padding(
                                      ...
                                      child: Autocomplete<String>(
                                        ...
                                        optionsBuilder: (textEditingValue) {
                                          ...
                                          return buscadorProductsRecordList
                                              .map((e) => e.name)
                                              .toList()
                                              .where((option) {
                                        ...
                                        fieldViewBuilder: (
                                          ...
                                          return TextFormField(
                                            ...
                                            onChanged: (_) =>
                                              ...
                                              () async {
                                                logFirebaseEvent(
                                                    'PRODUCTOS_TextField_zkcu16v0_ON_TEXTFIEL');
                                                logFirebaseEvent(
                                                    'TextField_simple_search');
                                                safeSetState(() {
                                                  _model.simpleSearchResults =
                                                      TextSearch(
                                                    buscadorProductsRecordList
                                                        .map(
                                                          (record) =>
                                                              TextSearchItem
                                                                  .fromTerms(
                      ...
                      if (FFAppState().searchInProducts == false)
                        Align(
                          alignment: const AlignmentDirectional(-1.0, 0.0),
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                            ...
                            child: StreamBuilder<List<HallwayRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<HallwayRecord> rowHallwayRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                }
                                final rowHallwayRecord =
                                    rowHallwayRecordList.isNotEmpty
                                        ? rowHallwayRecordList.first
                                        : null;
                      ...
                      if (FFAppState().searchInProducts == false)
                        Align(
                          alignment: const AlignmentDirectional(0.0, -4.86),
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 45.0),
                            child: AuthUserStreamWidget(
                                    ...
                                    itemBuilder: (context, listViewIndex) {
                                      ...
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PRODUCTOS_PAGE_Container_05ntvu9h_ON_TAP');
                                            logFirebaseEvent(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PRODUCTOS_PAGE_edit_outlined_ICN_ON_TAP');
                                                      logFirebaseEvent(
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'PRODUCTOS_delete_outline_rounded_ICN_ON_');
                                                        logFirebaseEvent(
                                                            'IconButton_alert_dialog');
                                                        await showDialog(
                                                          barrierColor:
                                                              const Color(0xD214181B),
                                                          context: context,
                                                          builder:
                                                              (dialogContext) {
                                                            return Dialog(
                      ...
                      if (FFAppState().searchInProducts == true)
                        Align(
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, productsSearchIndex) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PRODUCTOS_PAGE_Container_t5b19yuu_ON_TAP');
                                          logFirebaseEvent(
                                              'Container_navigate_to');
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 15.0, 30.0),
                  child: Column(
                    ...
                    children: [
                      Align(
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent('PRODUCTOS_PAGE_add_ICN_ON_TAP');
