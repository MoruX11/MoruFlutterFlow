...
class _RegalosWidgetState extends State<RegalosWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Regalos'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductsRecord> regalosProductsRecordList = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'REGALOS_PAGE_Icon_eaavwjvi_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: Autocomplete<String>(
                              ...
                              optionsBuilder: (textEditingValue) {
                                ...
                                return functions
                                    .filterProducts(
                                        regalosProductsRecordList.toList(),
                                        widget.town!,
                                        null,
                                        null)!
                              ...
                              fieldViewBuilder: (
                                ...
                                return TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    () async {
                                      logFirebaseEvent(
                                          'REGALOS_TextField_nj9edkcc_ON_TEXTFIELD_');
                                      logFirebaseEvent(
                                      ...
                                      FFAppState().searchInRegalos = true;
                                      safeSetState(() {});
                                      if (_model.textController.text == '') {
                                        logFirebaseEvent(
                                            'TextField_update_app_state');
                                        FFAppState().searchInRegalos = false;
                                        safeSetState(() {});
                                      } else {
                                        logFirebaseEvent(
                                            'TextField_update_app_state');
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: 'Encuentra el regalo perfecto...',
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'REGALOS_PAGE_Icon_yhq8redw_ON_TAP');
                  ...
                  if (FFAppState().searchInRegalos == false)
                    Padding(
                      padding:
                                  ...
                                  children: List.generate(products.length,
                                    ...
                                    return wrapWithModel(
                                      ...
                                      child: ProductListWidget(
                                        key: Key(
                                          'Keykei_${productsItem.reference.id}',
                                        ),
                  ...
                  if (FFAppState().searchInRegalos == true)
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                      child: ListView(
                                ...
                                return Wrap(
                                  ...
                                  children: List.generate(productsSearch.length,
                                    ...
                                    return ProductListWidget(
                                      key: Key(
                                          'Keys6c_${productsSearchIndex}_of_${productsSearch.length}'),
